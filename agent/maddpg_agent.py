...
class MADDPGAgent(RLAgent):
    def __init__(self, action_space, ob_generator, reward_generator, args, local_q_func=False):
        ...
        self.phase_list.remove(self.yellow_phase_id)
        self.phase_space = gym.spaces.Discrete(len(self.phase_list))
    ...
    def build_model(self, obs_shape_n, act_space_n):
        self.model = mlp_model
        self.name = self.iid
        self.n = len(obs_shape_n)
        agent_index = self.ob_generator.world.intersection_ids.index(self.iid)
        obs_ph_n = []
    ...
    def get_action(self, ob):
        ...
        self.action = self.phase_list[action_index]
        return self.action
